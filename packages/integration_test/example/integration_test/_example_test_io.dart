...
void main() {
  ...
  testWidgets('verify text1', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    app.main();
  ...
  testWidgets('verify text2', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    app.main();
  ...
  testWidgets('verify text3', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    app.main();
